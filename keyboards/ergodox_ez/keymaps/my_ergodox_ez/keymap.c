...
[BASE] = LAYOUT_ergodox_pretty(
  ...
  LT(MDIA,KC_TAB),  KC_A,        KC_S,          KC_D,    KC_F,    KC_G,                                        KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, LT(MDIA,KC_QUOT),
  KC_LSFT,          KC_Z,        KC_X,          KC_C,    KC_V,    KC_B,    KC_BSPC,                  KC_ENT, KC_N,    KC_M,    KC_COMM, KC_DOT,           KC_SLSH, KC_RSFT,
  KC_TRNS,          KC_TRNS,     KC_TRNS,       KC_LALT, KC_LGUI,                                              KC_RGUI,KC_RALT, KC_TRNS, KC_TRNS, KC_TRNS,
                                                           KC_TRNS, KC_TRNS,                KC_TRNS, KC_TRNS,
                                                                          KC_TRNS,                 KC_TRNS,
                                                                          MO(SYMB), CTL_T(KC_ESC), KC_TRNS,                  KC_TRNS, KC_SPC, MO(SYMB)
),
...
[SYMB] = LAYOUT_ergodox_pretty(
  ...
  KC_ESC,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                       KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT,  KC_TRNS, KC_ESC,
  KC_TRNS,   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,     KC_TRNS,  KC_LBRC, KC_RBRC, KC_TRNS, KC_TRNS,  KC_TRNS, KC_TRNS,
 ...
 * |        |      |      |      |      |      |      |           | Mute |      |      |      |      |      |        |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * |        |      | Lclk | MsUp | Rclk |      |Bright|           | VolUp|      | Lclk | RClk |      |      |        |
 * |--------+------+------+------+------+------|ness+ |           |      |------+------+------+------+------+--------|
...
[MDIA] = LAYOUT_ergodox_pretty(
  ...
  KC_TRNS, KC_TRNS, KC_BTN1, KC_MS_U, KC_BTN2, KC_TRNS, KC_TRNS,     KC_VOLU, KC_TRNS, KC_BTN1, KC_BTN2, KC_TRNS, KC_TRNS, KC_TRNS,
